    ...
    constructor(props) {
        ...
        this.state = {
            'alllocations': [
                ...
                {'name': "St. Xavier's College, Simdega",
                    'type': " College",
                    'latitude': 22.6189077,
                    'longitude': 84.4803089,
                    'streetAddress': "Samtoli, Simdega, Jharkhand 835223"},
                {'name': "SS Memorial College",
                    'type': " College",
                    'latitude': 23.3965425,
                    'longitude': 85.3147723,
                    'streetAddress': "Kanke Rd, Near Reliance Smart, Jawahar Nagar, Hatma, Ranchi, Jharkhand 834008"},    
